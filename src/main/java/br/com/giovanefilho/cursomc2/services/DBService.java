...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "mariasilva@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));

		Cliente cli2 = new Cliente(null, "Amanda Costa", "amandacostao@yahoo.com", "12345678909", TipoCliente.PESSOAFISICA, pe.encode("abc"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "11222333", cli2, c2);
